...
function sortFilterAsc(filesList, order) {
  var sortedFiles = [];
  switch (order.field) {
    case 'name':
...
function sortFilterDes(filesList, order) {
  var sortedFiles = [];
  switch (order.field) {
    case 'name':
      sortedFiles = filesList.sort(function (a, b) {
      ...
      console.log('sortedfile', sortedFiles);
      break;
    case 'size':
      sortedFiles = filesList.sort(function (a, b) {
        if (a.type == 'file' && b.type == 'folder') {
...
function sortFilter(filesList, order) {
  return order.orderBy === 'asc'
    ? sortFilterAsc(filesList, order)
    : sortFilterDes(filesList, order);
}
