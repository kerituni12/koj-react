...
import * as ClassicEditor from '@koj-react/ckeditor';
...
import ChallengeInput from './input.component';
        ...
        >
          ...
          <div style={{ zIndex: 1, display: 'block', width: '100%' }}>
            ...
            <div className="input-panel">
              <div className="wrap-inputs tab-active">
                <List
                  size="small"
                  dataSource={dataSource}
                  renderItem={(item) => <List.Item>{item}</List.Item>}
                  className={clsx('inputs', testCaseItem)}
                />
                {/* <ul className="inputs">
                ...
                <div className="wrap-inputs-content">
                  <div id="kiem-thu-1" className="input-content">
                  ...
                  <div id="kiem-thu-2" className="input-content active">
                  ...
                  <div id="kiem-thu-3" className="input-content">
                  ...
                  <div id="kiem-thu-4" className="input-content">
                  ...
                  <div id="kiem-thu-5" className="input-content">
                  ...
                  <div id="kiem-thu-6" className="case-hidden input-content">
                  ...
                  <div id="kiem-thu-7" className="case-hidden input-content">
                  ...
                  <div id="kiem-thu-8" className="case-hidden input-content">
                  ...
                  <div id="kiem-thu-9" className="case-hidden input-content">
                  ...
                  <div id="kiem-thu-10" className="case-hidden input-content">
...
const mapStateToProps = (store) => {
  console.log('🚀 ~ file: challenge-create.view.js ~ line 834 ~ store', store);
  return {
    store,
